...
final class TodoDetailPresentation: NSObject {
    ...
    override func isEqual(_ object: Any?) -> Bool {
        ...
        return self.detailTitle == other.detailTitle && self.explanation == other.explanation && self.date == other.date && self.isCompleted == other.isCompleted && self.notificationId == other.notificationId && self.isTheNotificationScheduled == isTheNotificationScheduled && self.colorType == other.colorType && self.id == other.id
    }
}
